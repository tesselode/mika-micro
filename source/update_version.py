...
def main():
  ...
  plistpath = scriptpath + "/resources/MikaMicro-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MikaMicro-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MikaMicro-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MikaMicro-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MikaMicro-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MikaMicro-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/MikaMicro-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/MikaMicro.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/MikaMicro.iss",inplace=1):
