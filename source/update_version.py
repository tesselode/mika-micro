...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright AndrewMinnich, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/CynthiaMicro-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/CynthiaMicro-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/CynthiaMicro-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/CynthiaMicro-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/CynthiaMicro-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/CynthiaMicro-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/CynthiaMicro-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/CynthiaMicro.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/CynthiaMicro.iss",inplace=1):
