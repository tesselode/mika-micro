...
void MikaMicro::InitPresets()
{
	...
	MakePresetFromNamedParams("Tesselode | Watchers", 38,
		...
		kGlideSpeed, 1.000000,
		kMasterVolume, 0.250000);
	MakePresetFromNamedParams("Alphagem-O | Knag", 38,
		kOsc1Wave, 4,
		kOsc1Coarse, -24,
		kOsc1Fine, 0.000000,
		kOsc1Split, 0.000977,
		...
		kFmFine, 0.000000,
		kFilterEnabled, true,
		kFilterCutoff, 4571.093750,
		kFilterResonance, 0.000000,
		kFilterKeyTrack, 0.484375,
		kVolEnvA, 0.500000,
		kVolEnvD, 998.572773,
		kVolEnvS, 0.000000,
		kVolEnvR, 994.611702,
		...
		kVolEnvCutoff, 0.000000,
		kModEnvFm, 11.625000,
		kModEnvCutoff, 3875.000000,
		kLfoFm, 6.187500,
		kLfoCutoff, 0.000000,
		kVoiceMode, 1,
		kGlideSpeed, 1.000000,
		kMasterVolume, 0.246094);
	...
	MakePresetFromNamedParams("Alphagem-O | Foam", 38,
		kOsc1Wave, 2,
		kOsc1Coarse, 0,
		kOsc1Fine, 0.101563,
		kOsc1Split, 0.005469,
		...
		kModEnvV, 0.000000,
		kLfoAmount, 0.057813,
		kLfoFrequency, 6.448381,
		kLfoDelay, 999.830132,
		kVolEnvFm, 0.000000,
		kVolEnvCutoff, 1500.000000,
		kModEnvFm, 0.000000,
		kModEnvCutoff, 0.000000,
		kLfoFm, 0.000000,
		kLfoCutoff, 0.000000,
	...
	MakePresetFromNamedParams("Alphagem-O | Mage", 38,
		kOsc1Wave, 2,
		kOsc1Coarse, -12,
		kOsc1Fine, -0.101563,
		kOsc1Split, 0.005469,
		...
		kFmFine, 0.000000,
		kFilterEnabled, true,
		kFilterCutoff, 269.375000,
		kFilterResonance, 0.238281,
		kFilterKeyTrack, 1.000000,
		kVolEnvA, 1000.000000,
		kVolEnvD, 998.000000,
		kVolEnvS, 0.569444,
		kVolEnvR, 997.828167,
		kVolEnvV, 0.000000,
